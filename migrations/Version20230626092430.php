 ...
 */
final class Version20230626092430 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE character_sheet (id INT AUTO_INCREMENT NOT NULL, game_id INT DEFAULT NULL, character_sheet_user_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, race VARCHAR(255) NOT NULL, class VARCHAR(255) NOT NULL, status INT DEFAULT NULL, initiative INT NOT NULL, hp_max INT NOT NULL, actual_hp INT NOT NULL, mp_max INT NOT NULL, actual_mp INT NOT NULL, strength INT NOT NULL, dexterity INT NOT NULL, stamina INT NOT NULL, intelligence INT NOT NULL, wisdom INT NOT NULL, luck INT NOT NULL, INDEX IDX_79FF7680E48FD905 (game_id), INDEX IDX_79FF76801FA37B51 (character_sheet_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE game (id INT AUTO_INCREMENT NOT NULL, gamer_id INT DEFAULT NULL, game_master_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, INDEX IDX_232B318C2F43A116 (gamer_id), INDEX IDX_232B318CC1151A13 (game_master_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, is_admin TINYINT(1) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE character_sheet ADD CONSTRAINT FK_79FF76801FA37B51 FOREIGN KEY (character_sheet_user_id) REFERENCES `user` (id)');
        ...
        $this->addSql('ALTER TABLE game ADD CONSTRAINT FK_232B318C2F43A116 FOREIGN KEY (gamer_id) REFERENCES `user` (id)');
